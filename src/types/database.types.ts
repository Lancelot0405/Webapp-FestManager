...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      expense_category_enum: "Vé tàu/xe" | "Uber/Taxi" | "Ăn uống" | "Khác"
...
export const Constants = {
  public: {
    Enums: {
      ...
      inventory_log_action_enum: ["set", "created"],
      inventory_unit_enum: [
        "kg", "g", "lít", "ml", "cái", "lon", "hộp", "xiên", "thùng",
        "phần", "túi", "gói", "lốc", "con", "miếng", "thanh", "viên",
        "lọ", "bình", "chiếc", "đôi", "bộ", "chai", "cuộn", "tấm", "ổ",
      ],
    },
  },
} as const
