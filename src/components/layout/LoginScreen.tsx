          ...
          <div className="flex w-full bg-brand-50 rounded-xl p-1 mb-6">
            {(['login', 'register'] as Mode[]).map(m => (
              <button
                ...
                type="button"
                onClick={() => reset(m)}
                className={`flex-1 text-sm font-semibold rounded-lg py-1.5 transition-all ${
                  mode === m
          ...
          {mode === 'login' && (
            <form onSubmit={handleLogin} className="w-full space-y-4">
              ...
              <Button
                ...
                fullWidth
                variant="primary"
                className="bg-brand-gradient text-white font-semibold py-3 shadow-warm active:scale-[0.98]"
              >
                {loading
                  ? <><span className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" /> Đang đăng nhập...</>
                  : 'Đăng nhập'}
              </Button>
            </form>
          )}
          ...
          {mode === 'register' && (
            <form onSubmit={handleRegister} className="w-full space-y-4">
              ...
              <Button
                ...
                fullWidth
                variant="primary"
                className={`text-white font-semibold py-3 shadow-warm active:scale-[0.98] ${
              ...
              >
                {loading
                  ...
                  : registerRole === 'manager' ? 'Gửi yêu cầu đăng ký' : 'Tạo tài khoản'}
              </Button>
            </form>
          )}

          {/* Footer */}
          <div className="border-t border-slate-100 mt-6 pt-4 flex items-center justify-center">
            <div className="relative">
              <button
