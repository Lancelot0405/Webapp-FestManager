    ...
    >
      <div className="flex justify-end items-center gap-1 h-11 px-3 pt-safe">
        ...
        <Popover isOpen={popoverOpen} onOpenChange={setPopoverOpen}>
          ...
          <Popover.Content placement="bottom end" className="p-0 w-80 max-h-[calc(100dvh-80px)] overflow-y-auto overflow-x-hidden rounded-2xl border border-separator/60 shadow-xl">
