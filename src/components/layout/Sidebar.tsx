...
export default function Sidebar({ onOpenSheet, notifCount = 0, notifications, clearAll, clearOne, onLogout }: SidebarProps) {
  ...
  return (
    <motion.aside
      className={`hidden md:flex flex-col ${w} shrink-0 sticky top-0 h-dvh pt-[env(safe-area-inset-top)] pl-[env(safe-area-inset-left)] bg-background border-r border-default-200 transition-[width] duration-200 overflow-hidden`}
