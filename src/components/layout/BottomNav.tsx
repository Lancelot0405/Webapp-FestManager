  ...
  return (
    ...
    >
      <Tabs
        ...
        className="w-full"
      >
        <Tabs.ListContainer className="w-full rounded-full p-1.5 bg-white dark:bg-zinc-900 border border-default-200 dark:border-default-100/10 shadow-lg shadow-black/10 dark:shadow-black/40">
          <Tabs.List
