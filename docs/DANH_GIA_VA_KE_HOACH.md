...
| 3.2 | Thay `alert()` bằng toast nhất quán | ⏳ Đề xuất |
| 3.3 | Thêm Vitest + Testing Library, test reducer & luồng auth | ⏳ Đề xuất |

### Giai đoạn 4 — UX/UI & design system

| # | Việc | Trạng thái |
|---|------|-----------|
| 4.1 | Component UI dùng chung: `Button`, `Input` | ✅ Đã làm (khởi đầu) |
| 4.2 | Thêm `aria-label` cho nút icon | ⏳ Đề xuất |
| 4.3 | Skeleton loader + empty state có minh họa | ⏳ Đề xuất |
| 4.4 | Token màu/spacing trong tailwind.config | ⏳ Đề xuất |
